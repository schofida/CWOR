...
function Fragment_1()
	...
	CWS.CWOCourierSentGlobal.SetValueInt(0)
endFunction
...
function Fragment_0()
	...
	elseIf CWS.PlayerAllegiance == CWS.iSons
		...
		CourierS.AddAliasToContainer(Alias_NoteFinalSons)
	endIf
	CWS.CWOCourierSentGlobal.SetValueInt(1)
endFunction
