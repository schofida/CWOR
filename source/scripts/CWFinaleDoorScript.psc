...
Event OnActivate(ObjectReference akActionRef)
	...
	if GetOwningQuest().GetStageDone(100) == False && (GetOwningQuest() as CWFinaleScript).CWs.CWOStillABetterEndingGlobal.GetValueInt() < 1 ;schofida - do not do this on final losing battle
